...
export const homeData = {
  bgImg: "home-bg.jpg",
  postTitle: blogData.blogOwner,
  postSubtitle: "Aquí ire dejando dichas mis cositas.",
};

export const contactData = {
  bgImg: "contact-bg.jpg",
  postTitle: "Contacta conmigo.",
  postSubtitle:
...
export const composeData = {
  bgImg: "compose-bg.jpg",
  postTitle: "Escribe algo.",
  postSubtitle: "Si estás aqui es porque quieres escribir algo.",
